...
type SkeletonLoaderTransactionItemsProps = ComponentPrimitiveProps & {
    count?: number;
}
const SkeletonLoaderTransactionItems = (props: SkeletonLoaderTransactionItemsProps) => {
    return (
...
export default SkeletonLoaderTransactionItems;