...
export const __countries = [
    ...
    { name: 'Congo, Democratic Republic of the', code: 'CD', flag: 'https://flagcdn.com/w320/cd.png' }, 
    ...
    { name: "Palestine", code: "PS", flag: "https://flagcdn.com/w320/ps.png" },
